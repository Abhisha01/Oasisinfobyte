        ...
        Array.from(z).forEach((r) => {
            ...
            // }
                   ...
                   screen.innerHTML=f+replaced
                    ...
                    // let output = window[f](eval(string))
                    // if (output.toString(10).length > 7) {
                    //     screen.innerHTML = f+replaced
        ...
        Array.from(b).forEach((e) => {
            ...
            f=''
                ...
                tap=true
                    ...
                    //         if (f == "n!") {
                    //             screen.innerHTML = fac(eval(string))
                    //             screen.style.cssText = "font-size:1rem;"
                    //         }
                    ...
                    //         else if (f == "√") {
                    //             if (Number.isInteger(square_root(eval(string)))) {
                    //                 screen.innerHTML = square_root(eval(string))
                    //             }

                    //             else {
                    //                 screen.innerHTML = square_root(eval(string)).toFixed(6)
                    //             }
                    ...
                    //             let output = window[f](eval(string))
                    //             if (output.toString(10).length > 7) {
                    //                 screen.innerHTML = output.toFixed(7)
